...
const App = () => {
  return (
    <Container text style={{ marginTop: '50px', marginBottom: '150px' }}>
      ...
      <Image
        src="/images/Lucy Butcher_hi-res square-min.png"
        centered
        size="huge"
      />
      ...
      <p>Freelance copy editor / proofreader</p>
      <p>
        Specialising in science, health and medicine (but all subjects welcome)
      </p>
      ...
      <p>
        <b>I’m an experienced writer.</b> But I’ve realised that I prefer
        editing. Improving a document’s accuracy and readability makes me
        strangely happy. So for now, this is my focus.
      </p>
      <p>
      ...
      <p>
        ...
        in a quiet home office, not an open-plan workplace with Spotify blaring.
      ...
      <p>
        <b>I don’t email my portfolio.</b> I respect client confidentiality and
        Rx communications regulations. But I’m always happy to chat about my
        experience.
      </p>
      <p>
        <b>I believe in science-based medicine and critical thinking.</b> I
        loathe Instagram influencers and their unreferenced health claims. I
        don’t work on anything dodgy or with flimsy evidence.
      </p>
      <p>
        You know who you are. You probably use words like ‘natural’, ‘organic’
        or ‘chemical free’ in your marketing (for more information, see{' '}
        <a href="https://isitchemicalfree.com">isitchemicalfree.com</a>).
      </p>
      <p>
        You may even subscribe to the religious health teachings of people like
        Pete Evans or Andrew Wakefield. Either way, I’m not the freelancer for
        you.
      </p>
